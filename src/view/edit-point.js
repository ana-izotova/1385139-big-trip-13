...
const createEditFormTemplate = (eventCard) => {
  const {type, startDate, endDate, destination, offers, description, photos, price} = eventCard;
              ...
              ${offers.length === 0 ? `` : `
                ...
                ${offers.map((offer) => {
                  return `<div class="event__offer-selector">
                            <input class="event__offer-checkbox  visually-hidden" id="event-offer-luggage-1" type="checkbox" name="event-offer-${offer.type}" ${offer.checked ? `checked` : ``}>
