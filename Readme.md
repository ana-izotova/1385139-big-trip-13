...
*Реализовала в проекте паттерн MVP с использованием классовых компонентов. Выполнен databinding. Использование сторонних библиотек `flatpickr.js`, `day.js`, `chart.js`*
