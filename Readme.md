...
Сборка: [Большое путешествие](https://big-trip-ana-izotova.vercel.app)
...
*Реализовала в проекте паттерн MVP с использованием классовых компонентов. Выполнен databinding. Использовала сторонние библиотеки `flatpickr.js`, `day.js`, `chart.js`. С помощью Service Workers добавила возможность удалять/добавлять в избранное карточки событий при отсутствии подключения к интернету.*
